...
static inline void heap_pa_percolate_up(struct heap_pa * h, uint32_t node) {
...
static inline void heap_pa_percolate_down(struct heap_pa * h, int32_t node) {
	struct heap_pa_elem tmp;
...
void heap_pa_extract_min(struct heap_pa * h, struct heap_pa_elem * dest)  {
...
void heap_pa_replace_min(struct heap_pa * h, struct heap_pa_elem * e) {
	assert(h != NULL && h->load > 0);
	h->array[0] = *e;
	heap_pa_percolate_down(h, 1);
}

void heap_pa_get_min(struct heap_pa * h, struct heap_pa_elem * dest) {
	assert(h != NULL && h->load > 0);
	*dest = h->array[0];
}
